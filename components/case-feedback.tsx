...
export function CaseFeedback({
  ...
  if (item.callFeedback)
    return (
      <section className="case-feedback" aria-label="Decision feedback">
        <strong>Feedback recorded</strong>
        <p>
          {item.callFeedback.value === "not_sure"
            ? "Not sure"
            : item.callFeedback.value === "yes"
              ? "Worked"
              : "Didn't work"}
        </p>
      </section>
