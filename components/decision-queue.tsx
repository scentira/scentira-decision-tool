...
export function DecisionQueue({items,renderDetail,onSelect}:{items:QueueItem[];renderDetail:(id:string)=>ReactNode;onSelect:(id:string|null)=>void}) {
 ...
 return <section aria-label="Decision queue"><h1>Decision queue</h1><p className="intro">One queue for submitted situations and decisions. Pending includes CoS answers awaiting founder review.</p>
